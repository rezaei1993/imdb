...
use Modules\Movie\App\Services\V1\ImdbCrawlerService;
use Modules\Movie\App\Services\V1\MovieService;

class MovieServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'Movie';

    protected string $moduleNameLower = 'movie';
    ...
    public function boot(): void
    {
        ...
        $this->app->bind(MovieRepositoryContract::class, MovieMysqlRepository::class);
        $this->app->bind(MovieServiceContract::class, MovieService::class);
        $this->app->bind(ImdbCrawlerServiceContract::class, ImdbCrawlerService::class);
    }
