...
use Modules\Media\App\Repositories\V1\Contracts\MediaRepositoryContract;
use Modules\Media\App\Repositories\V1\Mysql\MediaMysqlRepository;
...
class MediaServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->app->bind(MediaRepositoryContract::class, MediaMysqlRepository::class);
        $this->app->bind(FileServiceContract::class, VideoFileService::class);
        $this->app->bind(MediaFileServiceContract::class, MediaFileService::class);
    }
